...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i8.GetMessagesBloc>(
        () => _i8.GetMessagesBloc(gh<_i6.IChatRepository>()));
    gh.factory<_i9.GetAllChatsBloc>(
        () => _i9.GetAllChatsBloc(gh<_i6.IChatRepository>()));
    gh.factory<_i10.SendMessageBloc>(
        () => _i10.SendMessageBloc(gh<_i6.IChatRepository>()));
    gh.factory<_i11.SeenMessageBloc>(
        () => _i11.SeenMessageBloc(gh<_i6.IChatRepository>()));
    gh.lazySingleton<_i12.IAuthRepository>(() => _i13.FirebaseAuthRepository(
          gh<_i3.FirebaseAuth>(),
          gh<_i4.FirebaseFirestore>(),
        ));
    gh.factory<_i14.SignInBloc>(
        () => _i14.SignInBloc(gh<_i12.IAuthRepository>()));
    gh.factory<_i15.GetUserBloc>(
        () => _i15.GetUserBloc(gh<_i12.IAuthRepository>()));
    gh.factory<_i16.GetAllUsersBloc>(
        () => _i16.GetAllUsersBloc(gh<_i12.IAuthRepository>()));
    gh.factory<_i17.CreateChatRoomBloc>(() => _i17.CreateChatRoomBloc(
          gh<_i6.IChatRepository>(),
